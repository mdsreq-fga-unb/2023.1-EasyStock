...
|19/04/2023 | 0.2 | Formulando organização do projeto, planejamento das fases, matriz de comunicaçã, gerenciamento de riscos e critérios de planejamento | Hemanoel,Gustavo,Isaac,Daniela,Milena|
...
| Cliente | Declarar suas necessidades e fornecer o feedback do produto, e estabelecer o que deve ser atingido nas sprints, e validando se as metas foram alcançadas em cada entrega. | Daniella | Daniella |
...
| Daily Scrum (Mensagem via grupo do WhatsApp)    | Equipe do Projeto     | Diariamente      | Relatório das atividades individuais      |
...
| --------- | --------------- | :-------------: | 
| Modificações na equipe | Questão pessoal dos membros que impossibilite as atividades de desenvolvimento. | Baixa |
| Má comunicação com o cliente | Falta de interação com entre a Equipe e Cliente, reuniões com o cliente pouco objetivas. | Baixa |
...
| Problemas pessoais | Faculdade, estágio, trabalho, família, questões de saúde  | Alta |
...
* Trancamento de disciplina por parte dos integrantes da equipe;
